export default function SiteFooter({ personal }) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-6 grid md:grid-cols-4 gap-8">
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            />
            <span className="font-bold text-black">{personal.name}</span>
          </div>
        ...
        <div>
          ...
          <div className="space-y-2 text-xs">
            <p className="text-neutral-600">📍 {personal.location}</p>
            <p className="text-neutral-600">🌍 {personal.remoteAvailability}</p>
        ...
        <div className="space-y-4">
          ...
          <a href={`mailto:${personal.email}`} className="text-neutral-700 hover:text-black text-sm font-bold flex items-center gap-2 transition-colors">
          ...
          <a href={personal.whatsapp} target="_blank" rel="noreferrer" className="text-neutral-700 hover:text-black text-sm font-bold flex items-center gap-2 transition-colors">
            ...
            <span>{personal.phone} (WhatsApp)</span>
          </a>

          <div className="flex gap-4 pt-2">
            <a href={personal.github} className="text-neutral-400 hover:text-black transition-colors" title="GitHub">
            ...
            <a href={personal.linkedin} className="text-neutral-400 hover:text-black transition-colors" title="LinkedIn">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
              </svg>
            </a>
            <a href={personal.twitter} className="text-neutral-400 hover:text-black transition-colors" title="Twitter">
              <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
